...
if (age === null || age === "") {
  alert(`So sorry that you didn't want to enter your age :(`);
} else {
  alert(`You're ${age} years old.`);
}

const city = prompt('What city do you live in?').toLowerCase();
let cityInfo = "";
...
switch (city) {
  ...
  case null:
  case "":
    cityInfo = `So sorry that you didn't want to enter your city :(`;
    break;
  default:
...
const sport = prompt('What is your favorite sport?').toLowerCase();
let sportInfo = "";
